...
xgb.cv(data = dtrain, label = tr_label, nfold = 100, nround = 100, objective = "binary:logistic")

xgb_model <- xgb.train(data=dtrain, max_depth= ncol(ml_df), eta= 0.01, nthread = 91, nrounds= 91, objective = "binary:logistic")
