...
# Load the data
student_new <- fread('https://raw.githubusercontent.com/BYUIDSS/advising_studentriskW19/master/raw_data/student_new.csv?token=AKKUOQD5G2RAK77JUELSWFK6JWZAU',stringsAsFactors = F)
advising_new <- fread('https://raw.githubusercontent.com/BYUIDSS/advising_studentriskW19/master/raw_data/advising_new.csv?token=AKKUOQDPLAWQTEBQ7XYBGFC6JWY54',stringsAsFactors = F)
```
